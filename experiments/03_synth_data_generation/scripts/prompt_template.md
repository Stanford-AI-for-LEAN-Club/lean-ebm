...
You are generating a synthetic dataset of C and Python functions translated into Lean 4, with test cases, theorem statements, and proofs. Work in the directory: `WORKDIR_PLACEHOLDER`

## Your Batch

Process BOTH the C file and Python file for this batch:
- C source: `WORKDIR_PLACEHOLDER/c_src/BATCH_C_FILE`
- Python source: `WORKDIR_PLACEHOLDER/py_src/BATCH_PY_FILE`
...
`WORKDIR_PLACEHOLDER/output/BATCH_NAME.jsonl`
